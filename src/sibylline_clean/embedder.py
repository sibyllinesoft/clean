...
class MiniLMEmbedder:
    ...
    def __init__(
        ...
        Args:
            model_dir: Directory to cache model files. Defaults to ~/.cache/clean/models
        """
    ...
    def _default_model_dir() -> Path:
        ...
        cache = Path(cache_base) / "clean" / "models"
    ...
    def _ensure_loaded(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "onnxruntime is required for embeddings. Install with: pip install onnxruntime"
            ) from None
        ...
        try:
            ...
            raise ImportError(
                "tokenizers is required for embeddings. Install with: pip install tokenizers"
            ) from None
