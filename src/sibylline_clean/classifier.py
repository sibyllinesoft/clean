...
class InjectionClassifier:
    ...
    def _ensure_loaded(self) -> None:
        ...
        try:
            ...
            try:
                # Python 3.9+
                files = resources.files("sibylline_clean.models")
                ...
                # Python 3.8 fallback
                with resources.open_binary("sibylline_clean.models", self.MODEL_FILENAME) as f:
                    self._model = pickle.load(f)
                return
        ...
        cache_path = MiniLMEmbedder._default_model_dir() / self.MODEL_FILENAME
        ...
        raise RuntimeError(
            ...
            f"  - Package data: clean.models/{self.MODEL_FILENAME}\n"
            f"  - Cache: {cache_path}\n\n"
