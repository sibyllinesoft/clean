...
try:
    from ._native import normalize_text as _rust_normalize
...
class TextNormalizer:
    ...
    def __init__(self, use_confusables: bool = True):
        ...
        self._confusables_available: bool | None = None
    ...
    def normalize(self, text: str) -> str:
        ...
        """
        # Fast path: Rust fused normalization (skips confusables)
        if _HAS_NATIVE and not self._use_confusables:
            return _rust_normalize(text)
    ...
    def _normalize_unicode(self, text: str) -> str:
        ...
        Converts:
        - Fullwidth characters: fullwidth -> fullwidth
        - Compatibility characters: fi -> fi
        - Composed forms: e (decomposed) -> e (composed)
        """
